...
public:
	...
	virtual void socketDidOpen(::network::BaseSocket *) override;

	virtual void socketDidClose(::network::BaseSocket *) override;
...
private:
	...
	::network::Socket<::network::messages::Datagram> _socket;
